...
use Symfony\Component\Security\Http\Attribute\IsGranted; // <--- IMPORTANTE: Necesario para la seguridad

#[Route('/admin/element')] // <--- CAMBIO 1: Movemos todo a la zona /admin
#[IsGranted('ROLE_USER')]  // <--- CAMBIO 2: Protegemos todo el controlador
